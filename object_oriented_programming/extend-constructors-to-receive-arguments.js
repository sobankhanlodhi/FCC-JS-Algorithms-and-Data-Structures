...
are created with the Bird constructor are automatically named Albert, are blue in color, and have two legs. 
...
It would take a lot of time to create all the birds, then change the properties to different values 
for every one. To more easily create different Bird objects, you can design your Bird constructor to 
accept parameters:
...
it is created, which is one way that JavaScript constructors are so useful. 
...
let terrier = new Dog("Jackson", "Black");