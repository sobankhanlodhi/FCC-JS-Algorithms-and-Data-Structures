...
The ${variable} syntax used above is a placeholder. Basically, you won't have to use concatenation 
with the + operator anymore. To add variables to strings, 
...
Each list element's text should be one of the array elements from the failure 
