...
start by thinking about the following task: multiply the first n elements of an array to 
...
calling multiply again until n <= 0. At this point, all the functions can return and the 
