...
any other arrays nested within it. Notice it contains booleans, strings, and numbers, among 
other valid JavaScript data types:
...
Array.length. A more complex implementation of an array can be seen below. 
...
of at least 5 elements in length to the yourArray variable. Your array should contain at least one string, 
one number, and one boolean
*/

let yourArray = [true, 1, "One", "Soban", "Khan"];